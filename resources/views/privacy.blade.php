@extends('layouts.app')
@section('title', 'Privacy Policy-Viflix')
@section('content')
<!--==========================
Intro Section
============================-->
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="about-content">
				...
				<p class="essay">
Introduction
This privacy policy (“Policy”) describes how Viflix in Pakistan (“Company,” “we,” and “our”) processes, collects, uses and shares personal data when using this website http://www.viflix.net (the “Website”). Please read the following information carefully to understand our practices regarding your personal data and how we will process data.
